...
//
//        //修改为您要发送的手机号
//        String mobile = URLEncoder.encode("13720308660", ENCODING);
//
//        /**************** 查账户信息调用示例 *****************/
//        System.out.println(YunPianAPI.getUserInfo(apikey));
//
//        /**************** 使用智能匹配模版接口发短信(推荐) *****************/
...
//        System.out.println(YunPianAPI.tplSendSms(apikey, tpl_id, tpl_value, mobile));
//
//        /**************** 使用接口发语音验证码 *****************/
//        String code = "1234";
...
//    }
    ...
    public static String getUserInfo(String apikey) throws IOException, URISyntaxException {
        ...
        return post("https://sms.yunpian.com/v1/user/get.json", params);
    }
    ...
    public static String sendSms(String apikey, String text, String mobile) throws IOException {
        ...
        return post(YunPianAPI.URI_SEND_SMS, params);
    }
    ...
    public static String tplSendSms(String apikey, long tpl_id, String tpl_value, String mobile) throws IOException {
        ...
        params.put("mobile", mobile);
        return post(YunPianAPI.URI_TPL_SEND_SMS, params);
    }
    ...
    public static String sendVoice(String apikey, String mobile, String code) {
        ...
        return post(YunPianAPI.URI_SEND_VOICE, params);
    }
    ...
    public static String post(String url, Map<String, String> paramsMap) {
        ...
        try {
            ...
            if (paramsMap != null) {
                ...
                method.setEntity(new UrlEncodedFormEntity(paramList, YunPianAPI.ENCODING));
            }
